...
<section class="hero">
  ...
  <div class="hero-badge">✨ Guía de estilo visual</div>
  ...
  <div class="hero-quiz">
    ...
    <a href="{{ route('test') }}" class="btn-outline">🔬 Hacer test visual</a>
  </div>
</section>
...
<section class="faces-section" id="faces-grid-section">
  ...
  <div class="faces-grid" id="faces-grid">
    ...
    <div class="face-card reveal rd1" data-face="oval">
      <div class="card-visual" style="background:linear-gradient(135deg,#6B2FA0,#3D1A6E);">
        ...
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <ellipse cx="45" cy="58" rx="30" ry="42" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <rect x="26" y="48" width="14" height="9" rx="4" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.7"/>
            <rect x="50" y="48" width="14" height="9" rx="4" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.7"/>
            <line x1="40" y1="52.5" x2="50" y2="52.5" stroke="#E91E8C" stroke-width="1.5" opacity="0.7"/>
          </svg>
        </div>
    ...
    <div class="face-card reveal rd2" data-face="redondo">
      <div class="card-visual" style="background:linear-gradient(135deg,#2D6FA8,#1D4A88);">
        <div class="face-label-top">Forma de cara</div>
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <circle cx="45" cy="58" r="34" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <rect x="25" y="47" width="16" height="9" rx="2" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
            <rect x="49" y="47" width="16" height="9" rx="2" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
            <line x1="41" y1="51.5" x2="49" y2="51.5" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
          </svg>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="lens-list">
          ...
          <div class="lens-item">
            <div class="lens-item-icon">✈️</div>
            <div class="lens-item-text">
    ...
    <div class="face-card reveal rd3" data-face="cuadrado">
      <div class="card-visual" style="background:linear-gradient(135deg,#2DAA78,#1D8060);">
        <div class="face-label-top">Forma de cara</div>
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <rect x="16" y="20" width="58" height="76" rx="10" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <circle cx="34" cy="51" r="7" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
            <circle cx="56" cy="51" r="7" fill="none" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
            <line x1="41" y1="51" x2="49" y2="51" stroke="#E91E8C" stroke-width="1.5" opacity="0.8"/>
          </svg>
        </div>
    ...
    <div class="face-card reveal rd4" data-face="corazon">
      <div class="card-visual" style="background:linear-gradient(135deg,#E91E8C,#9B2070);">
        <div class="face-label-top">Forma de cara</div>
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <path d="M45 100 Q18 78 16 52 Q14 28 32 22 Q42 18 45 28 Q48 18 58 22 Q76 28 74 52 Q72 78 45 100 Z" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <path d="M24 47 Q26 42 34 43 Q40 43 40 48 Q40 53 32 53 Q24 53 24 47Z" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.4" opacity="0.8"/>
            <path d="M50 48 Q50 43 58 43 Q66 42 66 47 Q66 53 58 53 Q50 53 50 48Z" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.4" opacity="0.8"/>
            <line x1="40" y1="48" x2="50" y2="48" stroke="rgba(255,255,255,0.8)" stroke-width="1.4" opacity="0.8"/>
          </svg>
        </div>
    ...
    <div class="face-card reveal rd5" data-face="diamante">
      <div class="card-visual" style="background:linear-gradient(135deg,#A84F2F,#7A3018);">
        <div class="face-label-top">Forma de cara</div>
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <polygon points="45,12 74,50 45,98 16,50" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <ellipse cx="34" cy="47" rx="8" ry="5.5" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
            <ellipse cx="56" cy="47" rx="8" ry="5.5" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
            <line x1="42" y1="47" x2="48" y2="47" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
          </svg>
        </div>
    ...
    <div class="face-card reveal rd6" data-face="oblongo">
      <div class="card-visual" style="background:linear-gradient(135deg,#5B7BDE,#3A5AB8);">
        <div class="face-label-top">Forma de cara</div>
        <div class="face-svg-wrap">
          <svg viewBox="0 0 90 110" width="90" xmlns="http://www.w3.org/2000/svg">
            <ellipse cx="45" cy="58" rx="24" ry="44" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="2.5"/>
            ...
            <rect x="22" y="46" width="18" height="9" rx="4" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
            <rect x="50" y="46" width="18" height="9" rx="4" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
            <line x1="40" y1="50.5" x2="50" y2="50.5" stroke="rgba(255,255,255,0.8)" stroke-width="1.5" opacity="0.8"/>
          </svg>
        </div>
